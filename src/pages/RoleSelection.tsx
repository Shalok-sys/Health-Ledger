...
const roles: {
...
}[] = [
  {
    ...
    description:
      "View your longitudinal clinical record, manage care relationships, and see clinician contributions.",
  ...
  },
  {
    ...
    description:
      "A second patient perspective. Manage your own care relationships independently.",
    icon: <User className="h-8 w-8" />,
  },
  {
    id: "clinician-a",
    ...
    description:
      "Musculoskeletal Physiotherapy. Must contribute observations before accessing patient history.",
  ...
  },
  {
    ...
    description:
      "Sports Rehabilitation. Must contribute observations before accessing patient history.",
    icon: <Stethoscope className="h-8 w-8" />,
  },
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 sm:py-16">
      <div className="max-w-2xl w-full space-y-6 sm:space-y-10">
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 rounded-full bg-accent px-3 sm:px-4 py-1.5 text-xs sm:text-sm font-medium text-accent-foreground">
            <Shield className="h-3 w-3 sm:h-4 sm:w-4" />
            Behavior-First Prototype
          </div>
          <h1 className="text-2xl sm:text-4xl font-bold">
            Patient-Controlled Clinical History
          </h1>
          <p className="text-base sm:text-lg text-muted-foreground max-w-lg mx-auto px-2">
            Select a role to experience the system from that perspective. Data,
            actions, and visibility change immediately.
          </p>
        </div>
